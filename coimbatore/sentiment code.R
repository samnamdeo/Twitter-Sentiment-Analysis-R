...
combine<-read.csv("H:/smartcity/coimbatore/coimbatore.csv")

yay <- scan('H:/smartcity/coimbatore/positive-words.txt',what='character', comment.char=';')
boo <- scan('H:/smartcity/coimbatore/negative-words.txt',what='character', comment.char=';')
...
hist(sentimentscore,main="coimbatore Smartcity",col = rainbow(18))
