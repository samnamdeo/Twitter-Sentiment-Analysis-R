...
combine<-read.csv("H:/smartcity/bhubneswar/bhubneswar.csv")

yay <- scan('H:/smartcity/bhubneswar/positive-words.txt',what='character', comment.char=';')
boo <- scan('H:/smartcity/bhubneswar/negative-words.txt',what='character', comment.char=';')
...
hist(sentimentscore,main="bhubneswar Smartcity",col = rainbow(15))
